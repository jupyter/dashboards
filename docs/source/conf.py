...
# -*- coding: utf-8 -*-
#
# Dashboards documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'Dashboards.tex', 'Dashboards Documentation',
...
man_pages = [
    (master_doc, 'dashboards', 'Dashboards Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Dashboards', 'Dashboards Documentation',
     author, 'Dashboards', 'One line description of project.',
     'Miscellaneous'),
]
